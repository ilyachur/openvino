...
public:
    ...
    VisualizeTree(const std::string& file_name,
                  ...
                  bool dot_only = false) {}
    bool run_on_function(std::shared_ptr<ngraph::Function>) override { return false; }
...
protected:
    ...
    virtual std::string get_attributes(std::shared_ptr<Node> node) { return ""; }
    virtual std::string get_node_name(std::shared_ptr<Node> node) { return ""; }
